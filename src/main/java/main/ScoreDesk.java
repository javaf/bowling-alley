 ...
 * @author Gamer Rony
 */
public class ScoreDesk extends javax.swing.JFrame {

  /**
   * Creates new form ScoreDesk
   */
  public ScoreDesk() {
    initComponents();
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ScoreDesk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
//	frame.show();
  ...
  /**
   * This method receives a pinsetter event. The event is the current state of
   * the PinSetter and the method changes how the GUI looks accordingly. When
   * pins are "knocked down" the corresponding label is grayed out. When it is
   * the second roll, it is indicated by the appearance of a second yellow box
   * at the top.
   *
